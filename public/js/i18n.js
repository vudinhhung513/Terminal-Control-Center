...
(function () {
  ...
  var DICT = {
    ...
    'settings.sessionMaxAge': { en: 'Login expiry (hours)', vi: 'Thời hạn đăng nhập (giờ)' },
    'settings.sessionMaxAgeHint': { en: '(0 = until browser closes; re-login after change)', vi: '(0 = đến khi đóng trình duyệt; đổi xong cần đăng nhập lại)' },
